...
function OpportunityCard(props) {
  ...
  return (
    <div className="opportunityCard">
        ...
        <tr>
          <td className="cardImage">
            {props.skills != null ? (
              <img
                className="cardImage"
                src={icons[AOIOptions.indexOf(skill)]}
                alt="img"
              />
            ) : (
      ...
      <button className="cardDetails" onClick={navigateTo} src={props.details}>
        VIEW DETAILS <img className="cardArrow" src={arrow} alt="arrow" />
      </button>
    </div>
  );
}
