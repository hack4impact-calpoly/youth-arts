...
class RegistrationPage extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.state.firstName === "" && userId !== "") {
            ...
            fetch(
                `${process.env.REACT_APP_SERVER_URL}/api/volunteer/` + userId,
                { credentials: "include" }
            )
                .then((res) => res.json())
    ...
    getFileNames = (files) => {
        this.setState({
            picture: "https://pryac.s3-us-west-1.amazonaws.com/" + files[0],
        });
    };
                    ...
                    <form className="formStyle">
                        <div className="inputStyles">
                            ...
                            <label className="helperText">
                                *If your email did not autofill, please refresh
                                and try again until it does
                            </label>
                            <label htmlFor="Phone">
                                    ...
                                    return (
                                        <label key={option}>
                                            <input
                                                ...
                                                onChange={
                                                    this.handleRoleCheckBox
                                                }
                                                value={option}
                                                checked={
                                                    this.state.communityRole.indexOf(
                                                        option
                                                    ) !== -1
                                                }
                                                type="checkbox"
                                    ...
                                    return (
                                        <label key={option}>
                                            ...
                                            <input
                                                className="form-checkbox"
                                                onChange={
                                                    this.handleAOICheckBox
                                                }
                                                value={option}
                                                checked={
                                                    this.state.AOI.indexOf(
                                                        option
                                                    ) !== -1
                                                }
                                                type="checkbox"
                        ...
                        <div className="textStyle">
                            ...
                            <textarea
                                placeholder="Give us an oveview of your employment"
                        ...
                        <label className="finalCheckbox">
                            <input
                                ...
                                checked={this.state.boardMember}
                                onChange={this.handleBoardCheckBox}
                            />
                        ...
                        <label className="finalCheckbox">
                            <input
                                ...
                                onChange={this.handleWaiverCheckBox}
                            />
                            <label>
                                {" "}
                                I agree to the {}
                                <a
                                    id="waiverLink"
                                    target="_blank"
                                    href="https://drive.google.com/file/d/1j4sJyMCm9koe506kViPl6IWQ8YU3_bkQ/view?usp=sharing"
                                >
                                    digital volunteer waiver
                                </a>
                        ...
                        <div id="digitalSignature">
                            <label htmlFor="Address">
                                Digital Signature<span className="red">*</span>
                            </label>
                            <input
                                type="text"
                                name="signatureValue"
                                ...
                                onChange={this.handleSignatureValue}
                            />
                        </div>
                        <br />
                        {this.state.notValid && (
