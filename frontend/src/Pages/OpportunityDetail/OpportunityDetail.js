...
class OpportunityDetail extends React.Component {
    constructor(props) {
        ...
        this.updateCartWithOpportunity =
            this.updateCartWithOpportunity.bind(this);
                        ...
                        <table className="detailTable">
                            ...
                            <tbody>
                                {this.state.volunteers
                                    ? Object.keys(this.state.volunteers).map(
                                          (volunteers) => {
                                              var vol =
                                                  this.state.volunteerList.find(
                                                      (x) =>
                                                          x._id === volunteers
                                                  );
                                              return (
