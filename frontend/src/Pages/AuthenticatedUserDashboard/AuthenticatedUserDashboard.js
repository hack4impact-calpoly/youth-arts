            ...
            if (item === cancelOpp.id) {
                ...
                for (var i = 0; i < user.opportunities[key].length; i++) {
                    if (user.opportunities[key][i]._id === cancelOpp._id) {
                        ...
                        for (
                            var j = 0;
                            j < user.opportunities[key][i].start.length;
                            j++
                        ) {
                            if (
                                cancelOpp.start ===
                                    user.opportunities[key][i].start[j] &&
                                cancelOpp.end ===
                                    user.opportunities[key][i].end[j]
                            ) {
                                user.opportunities[key][i].start.splice(j, 1);
                                user.opportunities[key][i].end.splice(j, 1);
                                if (
                                    user.opportunities[key][i].start.length ===
                                    0
                                ) {
                    ...
                    if (opVols[j]._id === cancelOpp._id) {
                        for (var k = 0; k < opVols[j].start.length; k++) {
                            if (
                                ...
                                oppToUpdate.volunteers[props.user._id][
                                    j
                                ].start.splice(k, 1);
                                oppToUpdate.volunteers[props.user._id][
                                    j
                                ...
                                if (
                                    oppToUpdate.volunteers[props.user._id][j]
                                        .start.length === 0
                                ) {
                                    oppToUpdate.volunteers[
                                        props.user._id
                                    ].splice(j, 1);
                                }
                                break;
