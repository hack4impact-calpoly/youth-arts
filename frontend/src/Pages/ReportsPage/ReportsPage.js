        ...
        <div className="reportsTextOptions">
          <div className="reportsTextOptionsRow">
            ...
            <h6 className="reportsTextBullet">
              &emsp;&emsp;• Click 'EXPORT' in the top toolbar of the table.
            </h6>
            <h5 className="reportsTextOp">
              &emsp;2. Selected opportunity data CSV{" "}
            </h5>
            <h6 className="reportsTextBullet">
              &emsp;&emsp;• Select the checkbox for the preferred opportunity
              rows{" "}
            </h6>
            <h6 className="reportsTextBullet">
              &emsp;&emsp;• Click 'EXPORT' in the top toolbar of the table{" "}
          ...
          <div>
            ...
            <h6 className="reportsTextBullet">
              &emsp;&emsp;• Click 'Export Volunteers' next to the preferred
              opportunity.{" "}
            </h6>
            <h5 className="reportsTextOp">
              &emsp;4. Volunteer phone numbers and names for one opportunity CSV
            </h5>
            <h6 className="reportsTextBullet">
              &emsp;&emsp;• Click 'Export Phone Numbers' next to the preferred
              opportunity.{" "}
            </h6>
          </div>
          <div>
