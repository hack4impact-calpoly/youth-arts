...
const getVolunteer = async (userid) => await Volunteer.findById(userid);
...
const getAllOpportunities = async () => await Opportunity.find({});
...
const postNewVolunteerTask = async (
  ...
  const newVolunteer = await Volunteer.findByIdAndUpdate(volId, {
    opportunities: volunteer.opportunities,
  });
