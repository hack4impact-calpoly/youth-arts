                  ...
                  <div key={i}>
                    <div className="inputDate">
                      ...
                      {opportunity.start_event.length !== 1 && (
                        <input
                          ...
                          type="button"
                          value="X"
                          onClick={() => handleDeleteInputDate(i)}
                        />
                      )}
                    </div>
                    {opportunity.start_event.length - 1 === i && (
                      <input
                        ...
                        type="button"
                        value="Add Date"
                        onClick={(e) => handleAddInputDate(e)}
                      />
                    )}
                  </div>
                );
                ...
                <div className="inputButtons">
                  ...
                  {wishList.length !== 1 && (
                    <input
                      ...
                      type="button"
                      value="X"
                      onClick={() => handleDeleteInputWish(w)}
                    />
                  )}
                </div>
                {wishList.length - 1 === w && (
                  <input
                    ...
                    type="button"
                    value="Add Item"
                    onClick={(e) => handleAddInputWish(e)}
                  />
                )}
              </div>
            ))}
              ...
              <div key={t}>
                <div className="TaskDiv">
                  <div className="inputButtons">
                    ...
                    <div>
                      <label htmlFor="OpportunityTitle">
                        Task Name <span className="red">*</span>
                      </label>
                    </div>
                    <input
                      id="taskInput"
                    ...
                    {taskList.length !== 1 && (
                      <input
                        ...
                        type="button"
                        value="X"
                        onClick={() => handleDeleteInputTask(t)}
                      />
                    )}
                    <div>
                          ...
                          <div key={di}>
                            <div className="inputDate">
                              <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                <DateTimePicker
                                  className="FormDate"
                                  label="Start Date/Time"
                                  value={taskdate || moment().utc().local()}
                                  onChange={(e) =>
                                    handleStartChangeDateTask(e, t, di)
                                  }
                                />
                                <DateTimePicker
                                  className="FormDate"
                                  label="End Date/Time"
                                  value={end || moment().utc().local()}
                                  onChange={(e) =>
                                    handleEndChangeDateTask(e, t, di)
                                  }
                                />
                              </MuiPickersUtilsProvider>
                              {task.start.length !== 1 && (
                                <input
                                  ...
                                  value="X"
                                  onClick={() =>
                                    handleDeleteInputDateTask(t, di)
                                  }
                                />
                              )}
                            </div>
                            {task.start.length - 1 === di && (
                              <input
                                ...
                                type="button"
                                value="Add Date"
                                onClick={() => handleAddInputDateTask(t)}
                              />
                            )}
                          </div>
                        </div>
                    ...
                    {task.additionalInfo.map((req, r) => (
                      <div key={r}>
                        <div className="inputButtons" id="addReq">
                          ...
                          />
                          {task.additionalInfo &&
                            task.additionalInfo.length !== 1 && (
                              <input
                                id="deleteItem"
                                type="button"
                                value="X"
                                onClick={() => handleDeleteTaskReq(t, r)}
                              />
                            )}
                        </div>
                ...
                {taskList.length - 1 === t && (
                  <input
                    ...
                    type="button"
                    value="Add Task"
                    onClick={(e) => handleAddInputTask(e)}
                  />
                )}
              </div>
            ))}
            ...
            <div className="textStyle">
              ...
              <div className="IconSelect">
                {AOIOptions.map((option) => (
                  <label key={option}>
                    <img
                      src={icons[AOIOptions.indexOf(option)]}
                      width="auto"
                      height="30"
                      alt=""
                    />
                    <input
                      ...
                      checked={
                        opportunity.skills
                          ? opportunity.skills.indexOf(option) !== -1
                          : false
                      }
                      type="checkbox"
                    />{" "}
