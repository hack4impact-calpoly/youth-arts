...
function AddOpportunityForm(props) {
    ...
    const handleFormSubmit = (e) => {
        ...
        if (
            ...
            fetch(
                `${process.env.REACT_APP_SERVER_URL}/api/updateOpportunity/`,
                {
                    method: "POST",
                    headers: {
    ...
    const handleAOICheckBox = (e) => {
        ...
        if (
            opportunity.skills &&
            opportunity.skills.indexOf(newSelection) !== -1
        ) {
            opportunity.skills.splice(
                opportunity.skills.indexOf(newSelection),
                1
            );
        } else {
    ...
    const getFileNames = (files) => {
        for (let i = 0; i < files.length; i++) {
            opportunity.pictures.push(
                "https://pryac.s3-us-west-1.amazonaws.com/" + files[i]
            );
        }
    };
                    ...
                    <div className="OppformInside">
                        <div className="OppinputStyles">
                            <label htmlFor="OpportunityTitle">
                                Opportunity Title <span className="red">*</span>
                            </label>
                            <input
                                className="formInput"
                            ...
                            />
                            <label htmlFor="OpportunityTitle">
                                Opportunity Date<span className="red">*</span>
                            </label>
                            {(opportunity && opportunity.start_event
                                ? opportunity.start_event
                                : [""]
                            ).map((date, i) => {
                                ...
                                return (
                                    <div key={i}>
                                        <div className="inputDate">
                                            ...
                                            {opportunity.start_event.length !==
                                                1 && (
                                                <input
                                                    id="deleteItemDate"
                                                    type="button"
                            ...
                            <label htmlFor="OpportunityLocation">
                            ...
                            <input
                                ...
                                placeholder="Enter Opportunity Location Here"
                            />

                            <div className="textStyle">
                                <label htmlFor="OpportunityDescription">
                                ...
                                <textarea
                                    ...
                                    placeholder="Enter description of opportunity"
                                />
                                <br />
                            </div>
                        </div>
                        ...
                        <div className="OppinputStyles">
                            <label htmlFor="tasks">
                                Volunteer Tasks <span className="red">*</span>
                            </label>
                        </div>
                        {taskList.map((task, t) => {
                            return (
                                                        ...
                                                        <div key={di}>
                                                            <div className="inputDate">
                                                                ...
                                                                {task.start
                                                                    ...
                                                                    1 && (
                                                                    <input
                                                                        id="deleteItemDateTask"
                                                                        type="button"
                                                                        value="X"
                                                                        onClick={() =>
                                                                            handleDeleteInputDateTask(
                                                                                t,
                                                                                di
                                                                            )
                                                                        }
                        ...
                        <div className="textStyle">
                            <label htmlFor="Skill/Interests">
                                Skills/Interests <span className="red">*</span>
                            </label>
                                        ...
                                        {opportunity.requirements &&
                                            opportunity.requirements.length !==
                                                ...
                                                <input
                                                    ...
                                                    value="X"
                                                    onClick={() =>
                                                        handleDeleteOppReq(r)
                                                    }
                                                />
                                            )}
                                    </div>
                                    {opportunity.requirements.length - 1 ===
                                        r && (
                                        <input
                                            id="addItem"
                                            type="button"
                                            value="Add Requirement"
                                            onClick={(e) => handleAddOppReq()}
                                        />
                                    )}
                                </div>
                            );
                                        ...
                                        {opportunity.additionalInfo &&
                                            opportunity.additionalInfo
                                                ...
                                                <input
                                                    ...
                                                    value="X"
                                                    onClick={() =>
                                                        handleDeleteOppInfo(r)
                                                    }
                                                />
                                            )}
                                    </div>
                                    {opportunity.additionalInfo.length - 1 ===
                                        r && (
                                        <input
                                            id="addItem"
                                            type="button"
                                            value="Add Info"
                                            onClick={(e) => handleAddOppInfo()}
                                        />
                                    )}
                                </div>
                            );
