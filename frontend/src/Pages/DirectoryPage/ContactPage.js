                ...
                <Row>
                    ...
                    <Col id="contactInformation">
                        ...
                        <div id="volunteerStuff">
                            ...
                            <h5>
                                Role In The Community: {contact.communityRole}
                            </h5>
                        </div>
                        ...
                        <div id="outreach">
                            ...
                            <h5>
                                How Did They Hear About The Youth Arts?{" "}
                                {contact.outreach}
                            </h5>
                        </div>
                        <div id="outreach">
                            ...
                            <h5>
                                Board Member?{" "}
                                {contact && contact.boardMember ? "Yes" : "No"}
                            </h5>
                        </div>
                        <div id="outreach">
                            <h3 className="contactTitle">Events</h3>
                            {getEvents()
                                ? Object.keys(contact.opportunities).map(
                                      (oppId, index) =>
                                          contact.opportunities[oppId].map(
                                              (singleOpp, i) => {
                                                  var theOp =
                                                      props.allOpportunities.filter(
                                                          function (o) {
                                                              return (
                                                                  o._id ===
                                                                  oppId
