...
function BMLogHoursPage(props) {
  ...
  function handleSubmit(e) {
    ...
    let { volunteers } = boardOpportunity;
        ...
        <Form>
          <MuiPickersUtilsProvider utils={DateFnsUtils}>
            <DateTimePicker
              ...
              value={startDT || dateFormat(new Date(), " mmmm dS, yyyy ")}
              onChange={(e) => {
                setStartDT(e);
                console.log(e);
        ...
        {showLoggedModal ? (
          ...
          >
            ...
            <Modal.Body id="modalButtons">
              <Link to="/" id="modalButton" className="linkPadding">
                Go to Dashboard
              </Link>
              <Button
                id="modalButton"
                variant="primary"
                onClick={() => setshowLoggedModal(!showLoggedModal)}
              >
                Log more hours
              </Button>
            </Modal.Body>
